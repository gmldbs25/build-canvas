...
const basePath = (process.env.PAGES_BASE_PATH ?? "/world-model-orca").replace(
  /\/$/,
  "",
);
...
// Vinext's generated font and metadata markup keeps a few root-relative URLs.
// GitHub project pages live below a repository path, so prefix only paths that
// the Vite base setting has not already handled.
html = html
