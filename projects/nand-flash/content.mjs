...
export const sceneLearning = {
  ...
  ssd: ['SSD는 여러 칩이 함께 일하는 장치입니다. NAND Flash는 전원 없이 정보를 유지하는 반도체 메모리이고, Controller가 쓰고 읽는 일을 지휘합니다.', '밝은 테두리의 NAND 또는 아래 버튼을 눌러 안으로 들어가세요.'],
  ...
  wear: ['P/E Cycle은 쓰고 지우는 반복입니다. 반복 사용은 절연층과 읽기 특성을 바꿉니다. Wear Leveling은 마모를 분산하고, Bad Block은 사용할 수 없어 제외한 영역입니다.', '분산을 끄고 실행한 뒤, 켜고 다시 실행해 막대 높이를 비교하세요.'],
